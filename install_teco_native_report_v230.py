#!/usr/bin/env python3
"""
Te.Co Pandawa POS - Installer Analisis Native v2.3.0

Hasil:
- Analisis penjualan dan bahan masuk langsung ke index.html.
...
Jalankan dari root repository:
    python3 install_teco_native_report_v230.py
"""
...
VERSION = "2.3.0"
START = "<!-- TECO_NATIVE_REPORT_V230_START -->"
END = "<!-- TECO_NATIVE_REPORT_V230_END -->"


def backup(path: Path) -> Path:
    target = path.with_name(path.name + ".backup-before-native-v230")
...
"""
    ...
    print()
    print("Fitur utama terpasang pada index.html.")
