#!/usr/bin/env python3
"""
Te.Co Pandawa POS - Installer Analisis Native v2.2.0
...
Jalankan dari root repository:
    python3 install_teco_native_report_v220.py
"""
...
VERSION = "2.2.0"
START = "<!-- TECO_NATIVE_REPORT_V220_START -->"
END = "<!-- TECO_NATIVE_REPORT_V220_END -->"


def backup(path: Path) -> Path:
    target = path.with_name(path.name + ".backup-before-native-v220")
